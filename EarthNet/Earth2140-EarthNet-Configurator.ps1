...
$firewallPortTCP = @('213')
$firewallRuleNameTCP = "Earth2140_DirectPlay_TCP"
...
$firewallPortUDP = @('213')
$firewallRuleNameUDP = "Earth2140_DirectPlay_UDP"
...
# ICMP Firewall Rule for 10.21.40.0/24
$firewallRuleNameICMP = "EarthNet_Allow_ICMP_from_10.21.40.0/24"
...
else
{
    ...
    New-NetFirewallRule -DisplayName $firewallRuleNameICMP -Direction Inbound -Action Allow -Protocol ICMPv4 -RemoteAddress 10.21.40.0/24
